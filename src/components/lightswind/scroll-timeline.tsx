...
export const ScrollTimeline = ({
  ...
  const getCardClasses = (index: number) => {
    ...
    const variantClasses = {
      default: "bg-card border-0 shadow-sm",
      elevated: "bg-card border-0 border-border/40 shadow-md",
      outlined: "bg-card/50 backdrop-blur border-0 border-primary/20",
      filled: "bg-primary/10 border-0 border-primary/30",
    };
    const effectClasses = {
      none: "",
                ...
                >
                  ...
                  <motion.div
                    className={cn(
                      ...
                      "mt-12 lg:mt-0 border-1 rounded-4xl bg-slate-300/5 border-slate-200/10",
                    )}
                  ...
                  >
                    <Card className="bg-transparent border-0 rounded-4xl">
